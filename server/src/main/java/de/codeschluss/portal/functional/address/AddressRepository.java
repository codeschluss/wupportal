...
public interface AddressRepository extends FilteredJpaRepository<AddressEntity, String> {
  ...
  @Query("Select a from AddressEntity a where "
      + "a.houseNumber like %?1% or "
      + "a.place like %?1% "
      + "or a.postalCode like %?1% "
      + "or a.street like %?1% "
      + "or a.suburb.name like %?1% "
      + "or a.longitude like %?1% "
      + "or a.latitude like %?1%")
  Optional<List<AddressEntity>> findFiltered(String filter, Sort sort);

  @Query("Select a from AddressEntity a where "
      + "a.houseNumber like %?1% "
      + "or a.place like %?1% "
      + "or a.postalCode like %?1% "
      + "or a.street like %?1% "
      + "or a.suburb.name like %?1% "
  ...
  Optional<AddressEntity> findByHouseNumberAndPlaceAndPostalCodeAndStreet(String houseNumber,
      String place, String postalCode, String street);
