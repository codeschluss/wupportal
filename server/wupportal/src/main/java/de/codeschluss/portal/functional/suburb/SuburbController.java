...
public class SuburbController extends CrudController<SuburbEntity, SuburbService> {
	...
	@Override
	protected void checkForDuplicates(SuburbEntity newSuburb) {
		if (service.existsByName(newSuburb.getName())) {
			//TODO: Error Objects with proper message
			throw new DuplicateEntryException("Suburb already exists!");
		}
	}
